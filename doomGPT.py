"""
doom_like_full.py
A simplified "Doom-like" raycaster in pygame with:
- WASD movement (W/S forward/back, A/D turn)
- Stylized weapon overlay
- Minimap (top-left)
- Enemies that chase the player when in range/line-of-sight
- Bullets (spacebar) that kill enemies on hit
- Enemies damage the player on contact
All art is procedurally drawn (no external files).
"""
